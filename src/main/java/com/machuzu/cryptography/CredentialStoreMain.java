...
package com.machuzu.cryptography;
 ...
 */
public class CredentialStoreMain {
    ...
    public static void populateCredentialStore(final CredentialStore credentialStore) throws Exception {
        // Clear Password
    ...
    /*public static void main(String[] args) throws Exception {
        ...
        // Get an instance of the CredentialStoreMain
        CredentialStoreMain credentialStore = CredentialStoreMain.getInstance("KeyStoreCredentialStore", CREDENTIAL_STORE_PROVIDER);
        // Configure and Initialise the CredentialStoreMain
