...
@SessionScoped
@Named
public class EmployeesDeductions implements Serializable {
    ...
    private List<EmployeesDeductions> employees = new ArrayList<EmployeesDeductions>();   
    ...
    DeductionsProcessing bp = new DeductionsProcessing();
    ...
    public EmployeesDeductions() {
    }

    public EmployeesDeductions(String recNum, String idNumber, String taxNumber, String employeeNumber, String employmentDate, String empName, 
    ...
    public List<EmployeesDeductions> getAllDeductions() {
        ...
        try {
            ...
            while (results.next()) {   
                ...
                query = "SELECT * FROM employeedeductions where employeenumber = '" + results.getString(1) + "'";
                statement = connection.createStatement();
                results1 = statement.executeQuery(query);

                while (results1.next()) {               
                    employees.add(new EmployeesDeductions(results.getString(1), results.getString(3), results.getString(4), results.getString(5), results.getString(6), results.getString(7), results.getString(8), results1.getString(3), results1.getString(4)));                
                }
    ...
    public List<EmployeesDeductions> getEmployees() {
        getParams();
