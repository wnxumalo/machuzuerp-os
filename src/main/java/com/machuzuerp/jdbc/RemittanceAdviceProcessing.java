...
public class RemittanceAdviceProcessing {
    ...
    public RemittanceAdviceProcessing() {

    }

    public String editRemittanceAdvice(String uk, String func, String mod, String noteNumber) {
        try {
            ...
            connection = Systems.initConnection();
                ...
                if (!func.equals("")) {
                    ...
                    if (func.equals("delete")) {
                        ...
                        query = "delete from EmployeeDeduction where recnum = '" + noteNumber + "'";
...
*/
                    try {
                        ...
                        //if ((proceed == true)) {
                            ...
                            int added = 0;
                            statement = connection.createStatement();
                            query = "INSERT INTO remittanceadvice(remittancedate, invoicenumber, comments) VALUES ('" + sdf.format(remittanceDate) + "','" + 
    ...
    public int getMaxRec() throws SQLException {
        ...
        int i = 0;
        query = "SELECT max(recnum) FROM remittanceadvice";
        statement = connection.createStatement();
        results = statement.executeQuery(query);
