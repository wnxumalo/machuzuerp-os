...
@SessionScoped
public class CompliancePolicyController implements Serializable {

    @EJB
    private com.machuzuerp.controllers.jpa.PolicyFacade ejbFacade;
    private List<CompliancePolicy> items = null;
    private CompliancePolicy selected;

    public CompliancePolicyController() {
       
    }

    public CompliancePolicy getSelected() {
        return selected;
    }

    public void setSelected(CompliancePolicy selected) {
    ...
    public CompliancePolicy prepareCreate() {
        selected = new CompliancePolicy();
    ...
    public List<CompliancePolicy> getItems() {
        if (items == null) {
    ...
    public CompliancePolicy getPolicy(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<CompliancePolicy> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<CompliancePolicy> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
